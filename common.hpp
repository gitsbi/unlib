...
template<typename V> using                 kilogram = quantity<mass              , kilo_scaling, V>;
 ...
 */
namespace literals {
using integer_value_type = long; /**< value type of quantity return by integer literal operator */
...
#define UNLIB_DEFINE_METRIC_MICRO_PREFIXED_LITERAL_ATTO(Qty_,UnitShort_)  UNLIB_DEFINE_SCALED_LITERAL(Qty_,deci , d##UnitShort_) \
...
/** @{ macro unit prefixes */
/** define the literal operators for all the macro unit prefixes (deca-kilo) */
...
/** define the literal operators for all the macro unit prefixes (deca-mega) */
...
/** define the literal operators for all the macro unit prefixes (deca-giga) */
...
/** define the literal operators for all the macro unit prefixes (deca-peta) */
...
/** define the literal operators for all the macro unit prefixes (deca-exa) */
...
/** @{ mass */
UNLIB_DEFINE_LITERAL(gram                    , g       ) UNLIB_DEFINE_METRIC_MICRO_PREFIXED_LITERAL_ATTO(gram             , g   )
